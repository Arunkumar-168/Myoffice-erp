...
import 'package:flutter_application_1/course/common_functions.dart';
...
Future<UpdateUserModel> verifyEmail(
  ...
  const String apiUrl = BaseURL + "verify_email_address";
...
Future<UpdateUserModel> resendCode(String email) async {
  const String apiUrl = BaseURL + "resend_verification_code";
