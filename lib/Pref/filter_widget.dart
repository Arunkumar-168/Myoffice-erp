import 'dart:async';
import 'package:flutter_application_1/Pref/category.dart';
...
import '../search/misc_provider.dart';
...
class _FilterWidgetState extends State<FilterWidget> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<Categories>(context, listen: false).fetchAllCategory().then((_){
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    final allCategory = Provider.of<Categories>(context, listen: false).allItems;
    allCategory.insert(
        0, AllCategory(
        id: 0,
        title: 'All Category',
                        ...
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: DropdownButton(
                              ...
                              isExpanded: true,
                              hint: Text('All Sub-Category',
                                  style: const TextStyle(
                                    color: kSecondaryColor,
                                    fontSize: 15,
                                  )),
                              items: allCategory[subIndex].subCategory.map((cd) {
                                return DropdownMenuItem(
                                  value:
                                  cd.id == 0 ? 'all' : cd.id.toString(),
                                  child: Text(
