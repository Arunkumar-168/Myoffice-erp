import 'package:flutter_application_1/Pref/temp_view_screen.dart';
import 'package:flutter_application_1/online/tab_view_details.dart';
...
class _CourseDetailScreenState extends State<CourseDetailScreen>
  ...
  Widget build(BuildContext context) {
    final courseId = ModalRoute.of(context)!.settings.arguments as int ?? 0;
                          ...
                          if (!loadedCourseDetail.isPurchased!) {
                            if (_authToken != null) {
                              if (loadedCourse.isFreeCourse == '1') {
                                // final _url = BaseURL + 'enroll_free_course?course_id=$courseId&auth_token=$_authToken';
                                ...
                                final _url = BaseURL +
                                    'web_redirect_to_buy_course/$_authToken/$courseId';
                                _launchURL(_url);
                              }
                            } else {
                              CommonFunctions.showSuccessToast(
